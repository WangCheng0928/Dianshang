...
public class CartServiceImpl implements ICartService {
    ...
    public ServerReponse<CartVo> list(Integer userId){
        CartVo cartVo=this.getCartVoinit(userId);
        return ServerReponse.createBySuccess(cartVo);
    }

    public ServerReponse<CartVo> selectOrUnselect(Integer userId,Integer checked,Integer productId){
    ...
    private CartVo getCartVoinit(Integer useId){
        CartVo cartVo=new CartVo();
        List<Cart> cartList=cartMapper.selectCartByUserId(useId);
        ...
        cartVo.setAllChecked(this.getAllChecked(useId));
