...
//            RedisShardedPoolUtil.setEx(session.getId(), JsonUtil.obj2String(reponse.getData()), Const.RedisCacheExtime.REDIS_SESSION_EXTIME);
    ...
    @ResponseBody
    public ServerReponse<String> loginout(HttpSession session, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse){
...
//        RedisShardedPoolUtil.del(loginToken);
    ...
    @ResponseBody
    public ServerReponse<User> getUserInfo(HttpSession session, HttpServletRequest httpServletRequest){
